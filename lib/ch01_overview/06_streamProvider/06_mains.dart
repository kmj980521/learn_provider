...
import '../05_futureProvider/model/babies.dart';
import 'model/babies2.dart';
    ...
    return MultiProvider(
      providers: [
        ...
        StreamProvider<String>(
          create: (context){
            final int dogAge = context.read<Dog4>().age;
            final babies = Babies2(age : dogAge*2 );
            return babies.bark();
          },
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: 10.0,),
        Text(
          '- number of barks:${context.watch<String>()}', style: TextStyle(fontSize: 20.0),
        ),
